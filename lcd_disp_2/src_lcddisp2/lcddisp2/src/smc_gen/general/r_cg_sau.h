...
/*
    Serial Clock Select Register m (SPSmL)
*/
/* Section of operation clock (CKm1) (PRSm13 - PRSm10) */
...
#define _0F_SAU_CK01_CLEAR               (0x0FU)    /* clear bit4 - bit7 */
/* Section of operation clock (CKm0) (PRSm03 - PRSm00) */
...
#define _F0_SAU_CK00_CLEAR               (0xF0U)    /* clear bit0 - bit3 */
...
/*
    Format Of Serial Flag Clear Trigger Register mn (SIRmnL)
*/
/* Clear trigger of framing error of channel n (FECTmn) */
#define _04_SAU_SIRMN_FECTMN             (0x04U)    /* clears the FEFmn bit of the SSRmn register to 0 */
/* Clear trigger of parity error flag of channel n (PECTmn) */
#define _02_SAU_SIRMN_PECTMN             (0x02U)    /* clears the PEFmn bit of the SSRmn register to 0 */
/* Clear trigger of overrun error flag of channel n (OVCTmn) */
#define _01_SAU_SIRMN_OVCTMN             (0x01U)    /* clears the OVFmn bit of the SSRmn register to 0 */
...
/*
    Serial Output Level Register m (SOLmL)
*/
/* Selects inversion of the level of the transmit data of channel n in UART mode (SOLm2) */
#define _00_SAU_CHANNEL2_NORMAL          (0x00U)    /* normal bit level */
#define _04_SAU_CHANNEL2_INVERTED        (0x04U)    /* inverted bit level */
/* Selects inversion of the level of the transmit data of channel n in UART mode (SOLm0) */
