...
/*
    Timer Channel Start Register m (TSmL)
*/
/* Operation enable (start) trigger of channel 7 (TSm7) */
#define _00_TAU_CH7_START_TRG_OFF         (0x00U)    /* no trigger operation */
#define _80_TAU_CH7_START_TRG_ON          (0x80U)    /* operation is enabled (start trigger is generated) */
/* Operation enable (start) trigger of channel 6 (TSm6) */
#define _00_TAU_CH6_START_TRG_OFF         (0x00U)    /* no trigger operation */
#define _40_TAU_CH6_START_TRG_ON          (0x40U)    /* operation is enabled (start trigger is generated) */
/* Operation enable (start) trigger of channel 5 (TSm5) */
#define _00_TAU_CH5_START_TRG_OFF         (0x00U)    /* no trigger operation */
#define _20_TAU_CH5_START_TRG_ON          (0x20U)    /* operation is enabled (start trigger is generated) */
/* Operation enable (start) trigger of channel 4 (TSm4) */
#define _00_TAU_CH4_START_TRG_OFF         (0x00U)    /* no trigger operation */
#define _10_TAU_CH4_START_TRG_ON          (0x10U)    /* operation is enabled (start trigger is generated) */
/* Operation enable (start) trigger of channel 3 (TSm3) */
...
/*
    Timer Channel Stop Register m (TTmL)
*/
/* Operation stop trigger of channel 7 (TTm7) */
#define _00_TAU_CH7_STOP_TRG_OFF          (0x00U)    /* no trigger operation */
#define _80_TAU_CH7_STOP_TRG_ON           (0x80U)    /* operation is stopped (stop trigger is generated) */
/* Operation stop trigger of channel 6 (TTm6) */
#define _00_TAU_CH6_STOP_TRG_OFF          (0x00U)    /* no trigger operation */
#define _40_TAU_CH6_STOP_TRG_ON           (0x40U)    /* operation is stopped (stop trigger is generated) */
/* Operation stop trigger of channel 5 (TTm5) */
#define _00_TAU_CH5_STOP_TRG_OFF          (0x00U)    /* no trigger operation */
#define _20_TAU_CH5_STOP_TRG_ON           (0x20U)    /* operation is stopped (stop trigger is generated) */
/* Operation stop trigger of channel 4 (TTm4) */
#define _00_TAU_CH4_STOP_TRG_OFF          (0x00U)    /* no trigger operation */
#define _10_TAU_CH4_STOP_TRG_ON           (0x10U)    /* operation is stopped (stop trigger is generated) */
/* Operation stop trigger of channel 3 (TTm3) */
...
/*
    Timer Output Enable Register m (TOEmL)
*/
/* Timer output enable/disable of channel 7 (TOEm7) */
#define _80_TAU_CH7_OUTPUT_ENABLE         (0x80U)    /* the TOm7 operation enabled by count operation */
#define _00_TAU_CH7_OUTPUT_DISABLE        (0x00U)    /* the TOm7 operation stopped by count operation */
/* Timer output enable/disable of channel 6 (TOEm6) */
#define _40_TAU_CH6_OUTPUT_ENABLE         (0x40U)    /* the TOm6 operation enabled by count operation */
#define _00_TAU_CH6_OUTPUT_DISABLE        (0x00U)    /* the TOm6 operation stopped by count operation */
/* Timer output enable/disable of channel 5 (TOEm5) */
#define _20_TAU_CH5_OUTPUT_ENABLE         (0x20U)    /* the TOm5 operation enabled by count operation */
#define _00_TAU_CH5_OUTPUT_DISABLE        (0x00U)    /* the TOm5 operation stopped by count operation */
/* Timer output enable/disable of channel 4 (TOEm4) */
#define _10_TAU_CH4_OUTPUT_ENABLE         (0x10U)    /* the TOm4 operation enabled by count operation */
#define _00_TAU_CH4_OUTPUT_DISABLE        (0x00U)    /* the TOm4 operation stopped by count operation */
/* Timer output enable/disable of channel 3 (TOEm3) */
...
/*
    Timer Output Register m (TOmL)
*/
/* Timer output of channel 7 (TOm7) */
#define _00_TAU_CH7_OUTPUT_VALUE_0        (0x00U)    /* timer output value is "0" */
#define _80_TAU_CH7_OUTPUT_VALUE_1        (0x80U)    /* timer output value is "1" */
/* Timer output of channel 6 (TOm6) */
#define _00_TAU_CH6_OUTPUT_VALUE_0        (0x00U)    /* timer output value is "0" */
#define _40_TAU_CH6_OUTPUT_VALUE_1        (0x40U)    /* timer output value is "1" */
/* Timer output of channel 5 (TOm5) */
#define _00_TAU_CH5_OUTPUT_VALUE_0        (0x00U)    /* timer output value is "0" */
#define _20_TAU_CH5_OUTPUT_VALUE_1        (0x20U)    /* timer output value is "1" */
/* Timer output of channel 4 (TOm4) */
#define _00_TAU_CH4_OUTPUT_VALUE_0        (0x00U)    /* timer output value is "0" */
#define _10_TAU_CH4_OUTPUT_VALUE_1        (0x10U)    /* timer output value is "1" */
/* Timer output of channel 3 (TOm3) */
...
/*
    Timer Output Level Register m (TOLmL)
*/
/* Control of timer output level of channel 7 (TOLm7) */
#define _00_TAU_CH7_OUTPUT_LEVEL_H        (0x00U)    /* positive logic output (active-high) */
#define _80_TAU_CH7_OUTPUT_LEVEL_L        (0x80U)    /* inverted output (active-low) */
/* Control of timer output level of channel 6 (TOLm6) */
#define _00_TAU_CH6_OUTPUT_LEVEL_H        (0x00U)    /* positive logic output (active-high) */
#define _40_TAU_CH6_OUTPUT_LEVEL_L        (0x40U)    /* inverted output (active-low) */
/* Control of timer output level of channel 5 (TOLm5) */
#define _00_TAU_CH5_OUTPUT_LEVEL_H        (0x00U)    /* positive logic output (active-high) */
#define _20_TAU_CH5_OUTPUT_LEVEL_L        (0x20U)    /* inverted output (active-low) */
/* Control of timer output level of channel 4 (TOLm4) */
#define _00_TAU_CH4_OUTPUT_LEVEL_H        (0x00U)    /* positive logic output (active-high) */
#define _10_TAU_CH4_OUTPUT_LEVEL_L        (0x10U)    /* inverted output (active-low) */
/* Control of timer output level of channel 3 (TOLm3) */
...
/*
    Timer Output Mode Register m (TOMmL)
*/
/* Control of timer output mode of channel 7 (TOMm7) */
#define _00_TAU_CH7_MASTER_OUTPUT         (0x00U)    /* master channel output mode */
#define _80_TAU_CH7_SLAVE_OUTPUT          (0x80U)    /* slave channel output mode */
/* Control of timer output mode of channel 6 (TOMm6) */
#define _00_TAU_CH6_MASTER_OUTPUT         (0x00U)    /* master channel output mode */
#define _40_TAU_CH6_SLAVE_OUTPUT          (0x40U)    /* slave channel output mode */
/* Control of timer output mode of channel 5 (TOMm5) */
#define _00_TAU_CH5_MASTER_OUTPUT         (0x00U)    /* master channel output mode */
#define _20_TAU_CH5_SLAVE_OUTPUT          (0x20U)    /* slave channel output mode */
/* Control of timer output mode of channel 4 (TOMm4) */
#define _00_TAU_CH4_MASTER_OUTPUT         (0x00U)    /* master channel output mode */
#define _10_TAU_CH4_SLAVE_OUTPUT          (0x10U)    /* slave channel output mode */
/* Control of timer output mode of channel 3 (TOMm3) */
#define _00_TAU_CH3_MASTER_OUTPUT         (0x00U)    /* master channel output mode */
#define _08_TAU_CH3_SLAVE_OUTPUT          (0x08U)    /* slave channel output mode */
/* Control of timer output mode of channel 2 (TOMm2) */
#define _00_TAU_CH2_MASTER_OUTPUT         (0x00U)    /* master channel output mode */
#define _04_TAU_CH2_SLAVE_OUTPUT          (0x04U)    /* slave channel output mode */
/* Control of timer output mode of channel 1 (TOMm1) */
#define _00_TAU_CH1_MASTER_OUTPUT         (0x00U)    /* master channel output mode */
#define _02_TAU_CH1_SLAVE_OUTPUT          (0x02U)    /* slave channel output mode */
