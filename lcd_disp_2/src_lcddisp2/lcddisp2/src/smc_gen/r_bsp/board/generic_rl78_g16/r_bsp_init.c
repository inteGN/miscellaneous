...
void bsp_init_system(void)
{
    ...
    PIOR4 = BSP_CFG_PIOR40;

    /* The 10-pin products do not have the PIOR5 register. */

    PIOR6 = BSP_CFG_PIOR60 | (BSP_CFG_PIOR63 << 3U);
#elif BSP_CFG_MCU_PART_PIN_NUM < 2
    /* 16-pin */
    PIOR0 = BSP_CFG_PIOR00 | (BSP_CFG_PIOR02 << 2U) | (BSP_CFG_PIOR03 << 3U) |
            (BSP_CFG_PIOR04 << 4U) | (BSP_CFG_PIOR05 << 5U) | (BSP_CFG_PIOR06 << 6U);

    PIOR1 = BSP_CFG_PIOR10 | (BSP_CFG_PIOR11 << 1U) | (BSP_CFG_PIOR15 << 5U) |
            (BSP_CFG_PIOR17 << 7U);
    ...
    PIOR4 = BSP_CFG_PIOR40 | (BSP_CFG_PIOR42 << 2U) | (BSP_CFG_PIOR44 << 4U) |
            (BSP_CFG_PIOR45 << 5U) | (BSP_CFG_PIOR46 << 6U) | (BSP_CFG_PIOR47 << 7U);

    PIOR5 = BSP_CFG_PIOR50 | (BSP_CFG_PIOR51 << 1U) | (BSP_CFG_PIOR52 << 2U) |
            (BSP_CFG_PIOR54 << 4U);

    PIOR6 = BSP_CFG_PIOR60 | (BSP_CFG_PIOR61 << 1U) | (BSP_CFG_PIOR63 << 3U) |
            (BSP_CFG_PIOR64 << 4U) | (BSP_CFG_PIOR65 << 5U) | (BSP_CFG_PIOR66 << 6U);
    ...
    PIOR1 = BSP_CFG_PIOR10 | (BSP_CFG_PIOR11 << 1U) | (BSP_CFG_PIOR13 << 3U) |
            (BSP_CFG_PIOR15 << 5U) | (BSP_CFG_PIOR16 << 6U) | (BSP_CFG_PIOR17 << 7U);
    ...
    PIOR6 = BSP_CFG_PIOR60 | (BSP_CFG_PIOR61 << 1U) | (BSP_CFG_PIOR63 << 3U) |
            (BSP_CFG_PIOR64 << 4U) | (BSP_CFG_PIOR65 << 5U) | (BSP_CFG_PIOR66 << 6U);
#elif BSP_CFG_MCU_PART_PIN_NUM < 4
    /* 24-pin */
    PIOR0 = BSP_CFG_PIOR00 | (BSP_CFG_PIOR01 << 1U) | (BSP_CFG_PIOR02 << 2U) |
            (BSP_CFG_PIOR03 << 3U) | (BSP_CFG_PIOR04 << 4U) | (BSP_CFG_PIOR05 << 5U) |
            (BSP_CFG_PIOR06 << 6U);
    ...
    PIOR1 = BSP_CFG_PIOR10 | (BSP_CFG_PIOR11 << 1U) | (BSP_CFG_PIOR12 << 2U) |
            (BSP_CFG_PIOR13 << 3U) | (BSP_CFG_PIOR15 << 5U) | (BSP_CFG_PIOR16 << 6U) |
            (BSP_CFG_PIOR17 << 7U);

    PIOR2 = BSP_CFG_PIOR20 | (BSP_CFG_PIOR21 << 1U) | (BSP_CFG_PIOR22 << 2U) |
            (BSP_CFG_PIOR23 << 3U) | (BSP_CFG_PIOR24 << 4U);
